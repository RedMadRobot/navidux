...
/// This payload return as parameter in default implementation of `gotUpdatedData(_:)` or `output: ((NullablePayload) -> Void)` in `NavigationScreen` protocol.
/// If you want access data at this access point you have to override `gotUpdatedData(_:)` function in your inherited ViewController or use `output: ((NullablePayload) -> Void)`.
